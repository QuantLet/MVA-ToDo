...
% Quantlet:     MVAregzoom
% ---------------------------------------------------------------------
% Description:  MVAregzoom plots a section of the linear regression of 
%               the sales (X1) on price (X2) for the pullovers data 
%               (pullover.dat). Graphical representation of the 
%               relationship: total variation = explained variation + 
...
% Inputs:       None
% ---------------------------------------------------------------------
% Output:       Regression of sales (X1) on price (X2) of pullovers. The
%               overall mean is given by the dashed line.
% ---------------------------------------------------------------------
% Example:      -
% ------------------------------a---------------------------------------
